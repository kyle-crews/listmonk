...
get_config() {
	...
	download https://raw.githubusercontent.com/kyle-crews/listmonk/master/config.toml.sample config.toml
}

get_containers() {
	info "fetching docker-compose.yml from listmonk repo"
	download https://raw.githubusercontent.com/kyle-crews/listmonk/master/docker-compose.yml docker-compose.yml
}
